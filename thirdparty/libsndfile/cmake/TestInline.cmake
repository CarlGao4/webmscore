macro (TEST_INLINE)
	if (NOT DEFINED INLINE_CODE)
		...
		configure_file (${LIBSND_PATH}/cmake/TestInline.c.in ${PROJECT_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/TestInline.c)
		...
		if (HAVE_INLINE)
			...
			if (HAVE___INLINE)
				...
				if (HAVE___INLINE)
					...
					message (STATUS "Checking for __inline__...")
					set (INLINE_KEYWORD "__inline__")
					configure_file (${LIBSND_PATH}/cmake/TestInline.c.in ${PROJECT_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/cmake/TestInline.c)
