...
void initModule() {
    ...
    modularity::_ioc()->registerExport<playback::IPlaybackController>("", playbackController);
    modularity::_ioc()->registerExport<playback::ISoundProfilesRepository>("", new playback::SoundProfilesRepository());
